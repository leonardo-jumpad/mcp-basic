...
# ClientSession gerencia a sessão com servidor mcp (envia e recebe comenado)
# StdioServerParameters como inciar um servidor local
# stdio_client e sse_client : bibliotecas para comunicação stdio e sse
# AsyncExitStack utilitário para gerenciar os contextos de forma assincrono

# Usamos a instância da classe para chamar o servidor
# incialização (construtor)
# método assincrono para incialização do stdio local
# método incialização http com protocolo sse 
# métodos para listas ferramentas, recursos e prompts
# métodos para executar ferramentas, obter recursos e chamar prompts
# métodos para formatação de chamas de modelos de linguagem
